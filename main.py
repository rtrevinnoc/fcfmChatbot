        ...
        messages = [
            {
                ...
                "content": (
                    ...
                    "Cuando el contexto contenga ese formato, extrae los nombres de las materias y preséntalos ordenados por semestre, ignorando los códigos numéricos. No consideres las materias optativas en el plan de estudios general a menos que el usuario pregunte específicamente por ellas. IGNORA por completo cualquier materia optativa o semestre vacío al listar materias, a menos que el usuario pregunte explícitamente por ellas. "
